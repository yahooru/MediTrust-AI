...
import { FileLock2, Menu, X } from "lucide-react"
    ...
    >
      ...
      >
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white hidden sm:block">MediTrust AI</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button size="sm" className="shimmer-btn bg-white text-zinc-950 hover:bg-zinc-200 rounded-full px-4" asChild>
            <a href="/dashboard">Open Vault</a>
          </Button>
        </div>
